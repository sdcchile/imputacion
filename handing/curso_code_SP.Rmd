...
1. Si la falta de datos se produce de manera puramente aleatoria, se considera que el mecanismo de datos faltantes es MCAR (Missing Completely At Random).
2. Si la falta de datos se relaciona con otra variable observable, entonces el mecanismo de datos faltantes se considera MAR (Missing At Random).
3. Si la falta de datos depende del valor faltante en sí, entonces se considera que el mecanismo de datos faltantes es MNAR (Missing Not At Random).
